...
const FeedbackHistory = () => {
        ...
        return (
            <div>
                <BannerWrapper>
                    ...
                    <BannerText>Feedback Management System</BannerText>
                </BannerWrapper>
    ...
    return (
        <div>
            <BannerWrapper>
                <BannerImage src={bannerImg} alt="Banner" />
                <BannerText>Feedback Management – Repairs & Products</BannerText>
            </BannerWrapper>
            <div className="admin-dashboard">
                <div className="main-content">
                        ...
                        <div className="feedback-grid">
                            {feedbacks.length === 0 ? (
                                <div className="no-feedback">
                                    ...
                                    <p>No feedback yet. Be the first to review our repairs or products!</p>
                                </div>
                            ) : (
                                feedbacks.map((f) => (
                                    <div key={f._id} className="feedback-card">
                                        <div className="feedback-header">
                                            ...
                                            <div className="rating-badge">
                                                {f.rating ? calculateRating(f.rating) : 'No rating'}
                                            </div>
                                        </div>
                                        ...
                                        {f.response && (
                                            <div className="response-section">
                                                <div className="response-header">
                                                    ...
                                                    <h4>Response from Feedback Management Team</h4>
                                                </div>
                      ...
                      <span className="timestamp">
                        ...
                        <div className="feedback-form-section">
                            <div className="feedback-prompt">
                                ...
                                <p>
                                    Whether you used our repair services or purchased a product,
                                    your feedback helps us improve and provide better quality in the future.
                                </p>
                            </div>
