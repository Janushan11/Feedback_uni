                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Admin Dashboard – Manage feedback, ratings & complaints
                                </p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="mt-10">
                    <h2 className="text-xl font-semibold mb-3 flex items-center gap-2">
                        <AlertCircle className="w-5 h-5" /> Complaint Management
                    </h2>
                                ...
                                <CardHeader className="pb-2">
                                    <div className="flex items-center justify-between">
                                        <CardTitle className="text-base">
                                            {c.subject} • <span className="text-sm text-muted-foreground">{c.userName}</span>
                                        </CardTitle>
                                        <span className={`text-xs px-2 py-1 rounded-md border ${c.status === 'replied' ? 'text-green-400' : c.status === 'closed' ? 'text-red-400' : 'text-yellow-600'}`}>
                      {c.status}
                    </span>
                                    </div>
                                </CardHeader>
                                <CardContent>
                                    ...
                                    <div className="flex gap-2">
                                        <Button onClick={() => replyComplaint(c.complaintId)} className="border">
                                            <Reply className="w-4 h-4" /> Reply
                                        </Button>
                                        <Button onClick={() => closeComplaint(c.complaintId)} className="border">
                                            <CheckSquare className="w-4 h-4" /> Close
                                        </Button>
                                    </div>
                                </CardContent>
                            </Card>
                            ...
                            <Card>
                                <CardContent className="text-center py-8 text-muted-foreground">No complaints</CardContent>
                            </Card>
                        )}
                    </div>
                </div>
